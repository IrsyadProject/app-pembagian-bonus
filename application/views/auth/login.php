					...
					<div class="card-body">
						...
						<form action="<?= base_url() ?>" method="post">
							...
							<div class="d-grid gap-2">
								<button type="submit" class="btn btn-primary"><i class="fa-solid fa-right-to-bracket fa-fw"></i> Login</button>
								<a href="<?= base_url('register') ?>" class="btn btn-secondary gap-2"><i class="fa-solid fa-person-circle-plus fa-fw"></i> Registrasi</a>
							</div>
						</form>
					</div>
